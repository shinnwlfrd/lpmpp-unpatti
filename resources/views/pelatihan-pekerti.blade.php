  ...
  <!-- Background Section -->
    ...
    <div class="flex items-center justify-center px-6 py-16 text-blue-900">
      <div class="max-w-5xl w-full space-y-12">
        ...
        <!-- Judul Halaman -->
        <h1 class="text-3xl md:text-4xl font-extrabold mb-10 text-center text-blue-900 tracking-wide">
          Pelatihan PEKERTI
        </h1>

        <!-- Tentang PEKERTI -->
        <section>
          <h2 class="text-2xl font-bold mb-3 border-l-4 border-blue-600 pl-3"> Tentang PEKERTI</h2>
          <p class="text-lg leading-relaxed">
            Pelatihan PEKERTI (Peningkatan Keterampilan Dasar Teknik Instruksional) 
            merupakan program pengembangan kompetensi dosen yang bertujuan 
            untuk meningkatkan keterampilan pedagogik, penyusunan perangkat pembelajaran, 
            serta penerapan strategi pembelajaran aktif di perguruan tinggi.
          </p>
        </section>
        ...
        <section>
          ...
          <ul class="list-disc pl-6 space-y-2 text-lg">
            <li>Meningkatkan kemampuan dosen dalam merancang pembelajaran inovatif.</li>
            <li>Memperoleh sertifikat PEKERTI sebagai salah satu syarat jabatan fungsional.</li>
            <li>Meningkatkan kualitas penyusunan RPS, evaluasi pembelajaran, dan asesmen.</li>
          </ul>
        </section>
        ...
        <section>
          ...
          <p class="text-lg mb-4">
            Informasi jadwal pelatihan PEKERTI tahun berjalan akan diumumkan secara berkala. 
        ...
        <section>
          ...
          <div class="grid md:grid-cols-2 gap-6">
            <div class="p-5 bg-blue-50 rounded-xl shadow hover:shadow-lg transition">
              <h3 class="font-bold text-xl mb-2 text-blue-700">Rencana Pembelajaran Semester (RPS)</h3>
              <p>Penyusunan RPS berbasis OBE (Outcome Based Education).</p>
            </div>
            <div class="p-5 bg-indigo-50 rounded-xl shadow hover:shadow-lg transition">
              <h3 class="font-bold text-xl mb-2 text-indigo-700">Strategi Pembelajaran</h3>
              <p>Penerapan pembelajaran aktif, kolaboratif, dan berbasis teknologi.</p>
            </div>
            <div class="p-5 bg-purple-50 rounded-xl shadow hover:shadow-lg transition">
              <h3 class="font-bold text-xl mb-2 text-purple-700">Evaluasi & Asesmen</h3>
              <p>Teknik penilaian hasil belajar yang komprehensif dan adil.</p>
            </div>
            <div class="p-5 bg-pink-50 rounded-xl shadow hover:shadow-lg transition">
              <h3 class="font-bold text-xl mb-2 text-pink-700">Blended Learning</h3>
              <p>Pemanfaatan LMS, e-learning, dan media digital dalam perkuliahan.</p>
            </div>
          </div>
        </section>
