    ...
    <div class="max-w-5xl w-full space-y-12">
      ...
      <section>
        <p class="text-lg leading-relaxed text-justify mb-4">
          ...
          Selamat datang di laman resmi Lembaga Penjaminan Mutu dan Pengembangan Pembelajaran (LPMPP) Universitas Pattimura. 
          Sebagai lembaga yang bertanggung jawab atas penjaminan mutu dan pengembangan pembelajaran, kami berkomitmen untuk 
          memberikan layanan terbaik dalam pendampingan akreditasi, pelatihan dosen, serta inovasi pembelajaran. 
          LPMPP terus berupaya memperkuat sistem penjaminan mutu internal dan memfasilitasi peningkatan kapasitas sivitas akademika 
          agar tercipta kualitas pendidikan yang unggul dan berdaya saing.<br><br>
          Kami mengajak seluruh civitas akademika untuk berpartisipasi aktif dalam setiap program LPMPP, memanfaatkan layanan pendampingan, 
          dan bersama-sama meningkatkan mutu pendidikan di Universitas Pattimura.<br><br>
          Terima kasih atas perhatian dan kerja sama yang baik.<br><br>
          Salam hormat,<br>
          <strong>Dr. James Abrahamsz, M.Si</strong><br>
          Kepala LPMPP Universitas Pattimura


          <br><br><strong>HOTUMESE</strong><br><br>
        </p>
      </section>
