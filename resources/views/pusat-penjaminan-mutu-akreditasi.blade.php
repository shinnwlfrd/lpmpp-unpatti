  ...
  <section 
    ...
    <div class="container mx-auto">
      ...
      <h1 class="text-4xl md:text-5xl font-bold text-center text-blue-900 mb-12 transition-all duration-1000 opacity-0 animate-fade-down">
        Pusat Penjaminan Mutu Akreditasi
      </h1>
      ...
      <div class="flex flex-col lg:flex-row items-center lg:items-start gap-8 mb-8 opacity-0 animate-fade-up">
        ...
        <div class="flex-shrink-0 transform transition duration-700 hover:scale-105 hover:shadow-2xl">
          <img src="{{ asset('images/bruri.jpg') }}" 
               alt="Ketua Pusat Penjaminan Mutu Akreditasi" 
               class="rounded-lg w-64 lg:w-80 mx-auto lg:mx-0 shadow-lg" />
        </div>

        <!-- Info Ketua & Tabs -->
        <div class="flex-1 lg:pl-8">
          <h3 class="text-2xl font-bold mb-2">Dr. Bruri Melky Laimeheriwa, S.Pi., M.Si.</h3>
          <h6 class="text-blue-700 font-semibold mb-4">Ketua Pusat Penjaminan Mutu Akreditasi</h6>
              ...
              <table class="w-full table-auto bg-white">
                <tbody>
                  <tr class="border-b hover:bg-blue-50 transition">
                    ...
                    <td class="px-4 py-2">: Dr. Bruri Melky Laimeheriwa, S.Pi., M.Si.</td>
                  </tr>
                  <tr class="border-b hover:bg-blue-50 transition">
                    <td class="px-4 py-2 font-semibold">NIP</td>
                    <td class="px-4 py-2">: 197002211998031001</td>
                  </tr>
                  <tr class="border-b hover:bg-blue-50 transition">
      ...
      <div class="mt-6 rounded-lg overflow-hidden shadow-lg opacity-0 animate-fade-up">
        <h6 class="font-bold text-lg mb-4 px-4 py-2 bg-blue-700 text-white rounded-t-lg">
          Tugas Pokok Ketua Pusat Penjaminan Mutu dan Akreditasi
        </h6>
        <table class="w-full table-auto bg-white">
          <tbody>
            <tr class="border-b hover:bg-blue-50 transition">
              <td class="px-4 py-2 font-semibold">1 : Mengelola dan mengkoordinir pelaksanaan kegiatan pada Pusat Penjaminan Mutu dan Akreditasi di Lembaga Penjaminan Mutu dan Pengembangan Pembelajaran Universitas Pattimura, secara baik dan bertanggungjawab.;</td>
            </tr>
            <tr class="border-b hover:bg-blue-50 transition">
              <td class="px-4 py-2 font-semibold">2 : Tambahkan Tugas Pokok Lainnya;</td>
            </tr>
          </tbody>
        </table>
      </div>
