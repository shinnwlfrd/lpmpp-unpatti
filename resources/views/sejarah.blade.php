...
<main class="flex-grow font-['Poppins'] pt-36 bg-gradient-to-b from-white via-blue-50 to-white">
  ...
  <div class="flex items-center justify-center px-6 py-16 text-blue-900">
    <div class="max-w-5xl w-full space-y-12">
      ...
      <!-- Latar Belakang -->
      <section>
        <h2 class="text-2xl font-bold mb-3 border-l-4 border-blue-600 pl-3">📌 Latar Belakang</h2>
        <p class="text-lg leading-relaxed">
          Lembaga Penjaminan Mutu dan Pengembangan Pembelajaran (LPMPP) Universitas Pattimura dibentuk sebagai upaya untuk meningkatkan mutu pendidikan tinggi di lingkungan universitas. LPMPP berfokus pada pengembangan sistem penjaminan mutu internal serta peningkatan kualitas pembelajaran dan akreditasi program studi.
        </p>
      </section>

      <!-- Perjalanan Pembentukan -->
      <section>
        <h2 class="text-2xl font-bold mb-3 border-l-4 border-blue-600 pl-3">🛤️ Perjalanan Pembentukan</h2>
        <p class="text-lg leading-relaxed">
          LPMPP resmi berdiri pada tahun XXXX setelah melalui proses penggabungan beberapa unit pengembangan mutu dan pembelajaran di Universitas Pattimura. Sejak saat itu, LPMPP aktif mendukung dosen dan program studi melalui berbagai program pendampingan, pelatihan, dan inovasi pembelajaran.
        </p>
      </section>

      <!-- Pencapaian -->
      <section>
        <h2 class="text-2xl font-bold mb-3 border-l-4 border-blue-600 pl-3">🏆 Pencapaian</h2>
        <ul class="list-disc pl-6 space-y-2 text-lg">
          <li>Meningkatkan akreditasi institusi dan program studi di Universitas Pattimura.</li>
          <li>Menyelenggarakan program pelatihan dosen, seperti PEKERTI dan AA.</li>
          <li>Mengembangkan sistem informasi pembelajaran dan pendampingan akreditasi online.</li>
          <li>Memfasilitasi penyusunan dokumen akreditasi LED & LKPS secara efektif.</li>
        </ul>
      </section>

      <!-- Tim & Dukungan -->
      <section>
        <h2 class="text-2xl font-bold mb-3 border-l-4 border-blue-600 pl-3">👥 Tim & Dukungan</h2>
        <p class="text-lg leading-relaxed">
          Tim LPMPP terdiri dari tenaga ahli di bidang pendidikan, kurikulum, dan penjaminan mutu yang secara rutin memberikan bimbingan, workshop, dan konsultasi kepada dosen serta program studi di Universitas Pattimura.
        </p>
      </section>
