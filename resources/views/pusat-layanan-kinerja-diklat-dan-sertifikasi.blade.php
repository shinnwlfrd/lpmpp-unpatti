...
<main class="flex-grow font-['Poppins'] bg-gray-50 pt-40">
  ...
  <!-- Konten Profil -->
  <section class="bg-cover bg-center bg-no-repeat py-16 px-6 animate-fade-slide"
           style="background-image: url('/images/bg-grey.jpg'); background-size: cover;">

    <div class="container mx-auto">

      <!-- Judul -->
      <h1 class="text-4xl md:text-5xl font-bold text-center text-blue-900 mb-12 opacity-0 animate-fade-down">
        Pusat Layanan Kinerja Diklat dan Sertifikasi
      </h1>
      ...
      <div class="flex flex-col lg:flex-row items-center lg:items-start gap-8 mb-8 opacity-0 animate-fade-up">
        ...
        <div class="flex-shrink-0 transform transition duration-700 hover:scale-105 hover:shadow-2xl">
          <img src="{{ asset('images/Prof-Christina.jpeg') }}"
               alt="Ketua Pusat Layanan Kinerja Diklat dan Sertifikasi"
               class="rounded-lg w-64 lg:w-80 mx-auto lg:mx-0 shadow-lg" />
        </div>

        <!-- Info Ketua & Tabs -->
        <div class="flex-1 lg:pl-8">
          <h3 class="text-2xl font-bold mb-2">Prof.Dr.Christina Sososutiksno,.SE.,M.Si,Ak.,CA.</h3>
          <h6 class="text-blue-700 font-semibold mb-4">Ketua Pusat Layanan Kinerja Diklat dan Sertifikasi</h6>
              ...
              <table class="w-full table-auto bg-white">
                <tbody>
                  <tr class="border-b hover:bg-blue-50 transition">
                    ...
                    <td class="px-4 py-2">: Prof.Dr.Christina Sososutiksno,.SE.,M.Si,Ak.,CA.</td>
                  </tr>
                  <tr class="border-b hover:bg-blue-50 transition">
                    <td class="px-4 py-2 font-semibold">NIP</td>
                    <td class="px-4 py-2">: 197006121997032001</td>
                  </tr>
                  <tr class="border-b hover:bg-blue-50 transition">
                    <td class="px-4 py-2 font-semibold">NIDN</td>
                    <td class="px-4 py-2">: 0012067002</td>
                  </tr>
                  <tr class="border-b hover:bg-blue-50 transition">
      ...
      <div class="mt-6 rounded-lg overflow-hidden shadow-lg opacity-0 animate-fade-up">
        <h6 class="font-bold text-lg mb-4 px-4 py-2 bg-blue-700 text-white rounded-t-lg">
          Tugas Pokok Pusat Layanan Kinerja Diklat dan Sertifikasi
        </h6>
        <table class="w-full table-auto bg-white">
          <tbody>
            <tr class="border-b hover:bg-blue-50 transition">
              <td class="px-4 py-2 font-semibold">1 : Memimpin dan mengkoordinasi pengelolaan Pusat LKDS.</td>
            </tr>
            <tr class="border-b hover:bg-blue-50 transition">
              <td class="px-4 py-2 font-semibold">2 : Mengembangkan sistem monitoring dan evaluasi kinerja LKDS.</td>
            </tr>
            <tr class="border-b hover:bg-blue-50 transition">
              <td class="px-4 py-2 font-semibold">3 : Menyusun kebijakan dan standar layanan diklat dan sertifikasi.</td>
            </tr>
            <tr class="border-b hover:bg-blue-50 transition">
              <td class="px-4 py-2 font-semibold">4 : Menyediakan data dan informasi terkait program sertifikasi dosen dan tenaga kependidikan.</td>
            </tr>
            <tr class="border-b hover:bg-blue-50 transition">
              <td class="px-4 py-2 font-semibold">5 : Menjalin kerjasama dengan pihak eksternal untuk mendukung pengembangan LKDS.</td>
            </tr>
          </tbody>
        </table>
      </div>
