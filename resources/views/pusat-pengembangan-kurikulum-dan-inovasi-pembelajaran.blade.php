  ...
  <section 
    ...
    <div class="container mx-auto">
      ...
      <h1 class="text-4xl md:text-5xl font-bold text-center text-blue-900 mb-12 transition-all duration-1000 opacity-0 animate-fade-down">
        Pusat Pengembangan Kurikulum dan Inovasi Pembelajaran
      </h1>
      ...
      <div class="flex flex-col lg:flex-row items-center lg:items-start gap-8 mb-8 opacity-0 animate-fade-up">
        ...
        <div class="flex-shrink-0 transform transition duration-700 hover:scale-105 hover:shadow-2xl">
          <img src="{{ asset('images/avatar.jpg') }}" 
               alt="Ketua Pusat Pengembangan Kurikulum dan Inovasi Pembelajaran" 
               class="rounded-lg w-64 lg:w-80 mx-auto lg:mx-0 shadow-lg" />
        </div>

        <!-- Info Ketua & Tabs -->
        <div class="flex-1 lg:pl-8">
          <h3 class="text-2xl font-bold mb-2">Dr. Lisye Salamor, S.Pd., M.Pd.</h3>
          <h6 class="text-blue-700 font-semibold mb-4">Ketua Pusat Pengembangan Kurikulum dan Inovasi Pembelajaran</h6>
              ...
              <table class="w-full table-auto bg-white">
                <tbody>
                  <tr class="border-b hover:bg-blue-50 transition">
                    ...
                    <td class="px-4 py-2">: Dr. Lisye Salamor, S.Pd., M.Pd.</td>
                  </tr>
                  <tr class="border-b hover:bg-blue-50 transition">
                    <td class="px-4 py-2 font-semibold">NIP</td>
                    <td class="px-4 py-2">: 198012162005012002</td>
                  </tr>
                  <tr class="border-b hover:bg-blue-50 transition">
                    <td class="px-4 py-2 font-semibold">NIDN</td>
                    <td class="px-4 py-2">: 0021027003</td>
                  </tr>
                  <tr class="border-b hover:bg-blue-50 transition">
      ...
      <div class="mt-6 rounded-lg overflow-hidden shadow-lg opacity-0 animate-fade-up">
        <h6 class="font-bold text-lg mb-4 px-4 py-2 bg-blue-700 text-white rounded-t-lg">
          Tugas Pokok Pusat Pengembangan Kurikulum dan Inovasi Pembelajaran
        </h6>
        <table class="w-full table-auto bg-white">
          <tbody>
            <tr class="border-b hover:bg-blue-50 transition">
              <td class="px-4 py-2 font-semibold">1 : Mengelola dan mengkoordinir kegiatan Pusat Pengembangan Kurikulum dan Inovasi Pembelajaran secara baik dan bertanggungjawab;</td>
            </tr>
            <tr class="border-b hover:bg-blue-50 transition">
              <td class="px-4 py-2 font-semibold">2 : Menyusun inovasi kurikulum untuk peningkatan mutu pembelajaran;</td>
            </tr>
            <tr class="border-b hover:bg-blue-50 transition">
              <td class="px-4 py-2 font-semibold">3 : Melakukan evaluasi dan monitoring pelaksanaan kurikulum;</td>
            </tr>
            <tr class="border-b hover:bg-blue-50 transition">
              <td class="px-4 py-2 font-semibold">4 : Berkoordinasi dengan program studi dan fakultas terkait implementasi pembelajaran;</td>
            </tr>
            <tr class="border-b hover:bg-blue-50 transition">
              <td class="px-4 py-2 font-semibold">5 : Menyediakan dokumentasi dan laporan kurikulum untuk kebutuhan akreditasi;</td>
            </tr>
          </tbody>
        </table>
      </div>
