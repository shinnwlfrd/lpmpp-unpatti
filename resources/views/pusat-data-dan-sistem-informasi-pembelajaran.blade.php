  ...
  <section 
    ...
    <div class="container mx-auto">
      ...
      <h1 class="text-4xl md:text-5xl font-bold text-center text-blue-900 mb-12 transition-all duration-1000 opacity-0 animate-fade-down">
        Pusat Data dan Sistem Informasi Pembelajaran
      </h1>
      ...
      <div class="flex flex-col lg:flex-row items-center lg:items-start gap-8 mb-8 opacity-0 animate-fade-up">
        ...
        <div class="flex-shrink-0 transform transition duration-700 hover:scale-105 hover:shadow-2xl">
          <img src="{{ asset('images/Francis.png') }}" 
               alt="Ketua Pusat Data dan Sistem Informasi Pembelajaran" 
               class="rounded-lg w-64 lg:w-80 mx-auto lg:mx-0 shadow-lg" />
        </div>

        <!-- Info Ketua & Tabs -->
        <div class="flex-1 lg:pl-8">
          <h3 class="text-2xl font-bold mb-2">Francis Y. Rumlawang, S.Si., M.Si.</h3>
          <h6 class="text-blue-700 font-semibold mb-4">Ketua Pusat Data dan Sistem Informasi Pembelajaran</h6>
              ...
              <table class="w-full table-auto bg-white">
                <tbody>
                  <tr class="border-b hover:bg-blue-50 transition">
                    ...
                    <td class="px-4 py-2">: Francis Y. Rumlawang, S.Si., M.Si.</td>
                  </tr>
                  <tr class="border-b hover:bg-blue-50 transition">
                    <td class="px-4 py-2 font-semibold">NIP</td>
                    <td class="px-4 py-2">: 197206171999031005</td>
                  </tr>
                  <tr class="border-b hover:bg-blue-50 transition">
                    <td class="px-4 py-2 font-semibold">NIDN</td>
                    <td class="px-4 py-2">: 0017067208</td>
                  </tr>
                  <tr class="border-b hover:bg-blue-50 transition">
                    <td class="px-4 py-2 font-semibold">Jabatan Fungsional</td>
                    <td class="px-4 py-2">: Lektor Kepala</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <table class="w-full table-auto bg-white">
                <tbody>
                  ...
                  <tr class="border-b hover:bg-blue-50 transition">
                    ...
                    <td class="px-4 py-2">: Sains dan Teknologi</td>
                  </tr>
                </tbody>
              </table>
            </div>
      ...
      <div class="mt-6 rounded-lg overflow-hidden shadow-lg opacity-0 animate-fade-up">
        <h6 class="font-bold text-lg mb-4 px-4 py-2 bg-blue-700 text-white rounded-t-lg">
          Tugas Pokok Pusat Data dan Sistem Informasi Pembelajaran
        </h6>
        <table class="w-full table-auto bg-white">
          <tbody>
            <tr class="border-b hover:bg-blue-50 transition">
              <td class="px-4 py-2 font-semibold">1 : Mengumpulkan data dari semua bidang di LPMPP;</td>
            </tr>
            <tr class="border-b hover:bg-blue-50 transition">
              <td class="px-4 py-2 font-semibold">2 : Menganalisis data yang diperlukan dalam mendukung kegiatan LPMPP;</td>
            </tr>
            <tr class="border-b hover:bg-blue-50 transition">
              <td class="px-4 py-2 font-semibold">3 : Mengevaluasi data yang selama ini dipakai dalam kegiatan LPMPP;</td>
            </tr>
            <tr class="border-b hover:bg-blue-50 transition">
              <td class="px-4 py-2 font-semibold">4 : Mengoptimalkan Website LPMPP untuk keperluan publikasi;</td>
            </tr>
            <tr class="border-b hover:bg-blue-50 transition">
              <td class="px-4 py-2 font-semibold">5 : Memberikan informasi yang akurat terkait keberadaan program studi sehingga dapat menjadi peringatan dini dalam mengelolah akreditasi program studi;</td>
            </tr>
            <tr class="border-b hover:bg-blue-50 transition">
              <td class="px-4 py-2 font-semibold">6 : Menyiapkan dokumen-dokumen mutu yang dapat diakses untuk kebutuhan akreditasi;</td>
            </tr>
            <tr class="border-b hover:bg-blue-50 transition">
              <td class="px-4 py-2 font-semibold">7 : Berkoordinasi dengan UPA terkait dengan SIAKAD dan LMS;</td>
            </tr>
            <tr class="border-b hover:bg-blue-50 transition">
              <td class="px-4 py-2 font-semibold">8 : Berkoordinasi dengan Prodi terkait dengan Instrumen pembelajaran.</td>
            </tr>
          </tbody>
        </table>
      </div>
