...
<main class="flex-grow font-['Poppins']">
    <div class="container mx-auto px-6 pt-48 pb-12">
        <h2 class="text-3xl font-bold text-blue-900 mb-6 text-center">
            SURVEY KEPUASAN MAHASISWA, DOSEN DAN TENDIK
        </h2>
            ...
            <table id="dokumenTable" class="min-w-full border border-gray-300">
                <thead>
                    <tr>
                        ...
                        <th class="text-center px-4 py-3 bg-blue-900 text-white w-24">Tahun</th>
                        <th class="text-center px-4 py-3 bg-blue-900 text-white w-48">Aksi</th>
                    </tr>
                </thead>
                <tbody>
                    ...
                    <tr class="{{ $index % 2 == 0 ? 'bg-blue-50' : 'bg-gray-100' }} hover:bg-blue-100">
                        ...
                        <td class="text-center px-4 py-3 border border-blue-900">{{ $doc->tahun ?? '-' }}</td>
                        <td class="text-center px-4 py-3 border border-blue-900">
                            <a href="{{ $doc->getDownloadUrl() }}" target="_blank" 
                               class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600 inline-block">
                                Download Hasil Survey
                            </a>
                        </td>
                    </tr>
                    @empty
                    <tr>
                        <td colspan="4" class="text-center px-4 py-8 text-gray-500">Belum ada dokumen</td>
                    </tr>
                    @endforelse
                </tbody>
            </table>
