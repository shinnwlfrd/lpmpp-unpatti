  ...
  <table id="dokumenTable" class="min-w-full border border-gray-300">
    <thead>
      <tr>
        ...
        <th class="text-left px-4 py-2 bg-blue-900 text-white">NAMA LEMBAGA</th>
    ...
    <tbody>
      ...
      <tr>
        ...
        <td class="px-4 py-2">LAMINFOKOM</td>
        <td class="text-center px-4 py-2">
          <a href="https://drive.google.com/uc?export=download&id=ID_FILE_DRIVE" target="_blank" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
            Download Semua Pedoman
          </a>
      ...
      <tr>
        ...
        <td class="px-4 py-2">LAMPTKES</td>
        <td class="text-center px-4 py-2">
          <a href="hhttps://drive.google.com/uc?export=download&id=ID_FILE_DRIVE" target="_blank" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
            Download Semua Pedoman
          </a>
        </td>
      </tr>
      ...
      <tr>
        <td class="text-center px-4 py-2">5</td>
        <td class="px-4 py-2">LAMDIK</td>
        <td class="text-center px-4 py-2">
          <a href="https://drive.google.com/uc?export=download&id=ID_FILE_DRIVE" target="_blank" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
            Download Semua Pedoman
          </a>
      ...
      <tr>
        <td class="text-center px-4 py-2">6</td>
        <td class="px-4 py-2">BAN-PT</td>
        <td class="text-center px-4 py-2">
          <a href="https://drive.google.com/uc?export=download&id=ID_FILE_DRIVE" target="_blank" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
            Download Semua Pedoman
          </a>
      ...
      <tr>
        <td class="text-center px-4 py-2">7</td>
        <td class="px-4 py-2">LAM-SPAK</td>
        <td class="text-center px-4 py-2">
          <a href="https://drive.google.com/uc?export=download&id=ID_FILE_DRIVE" target="_blank" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
            Download Semua Pedoman
          </a>
      ...
      <tr>
        <td class="text-center px-4 py-2">8</td>
        <td class="px-4 py-2">LAM-PTIP</td>
        <td class="text-center px-4 py-2">
          <a href="https://drive.google.com/uc?export=download&id=ID_FILE_DRIVE" target="_blank" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
            Download Semua Pedoman
          </a>
      ...
      <tr>
        <td class="text-center px-4 py-2">9</td>
        <td class="px-4 py-2">LAM-TEKNIK</td>
        <td class="text-center px-4 py-2">
          <a href="https://drive.google.com/uc?export=download&id=ID_FILE_DRIVE" target="_blank" class="bg-blue-500 text-white px-4 py-2 rounded hover:bg-blue-600">
            Download Semua Pedoman
          </a>
