...
<main class="flex-grow font-['Poppins'] pt-36 bg-gradient-to-b from-white via-blue-50 to-white">
  <!-- Konten Pelatihan AA -->
  <div class="flex items-center justify-center px-6 py-16 text-blue-900">
    <div class="max-w-5xl w-full space-y-12">

      <!-- Judul Halaman -->
      <h1 class="text-3xl md:text-4xl font-extrabold mb-10 text-center tracking-wide">
        Pelatihan Applied Approach (AA)
      </h1>

      <!-- Tentang AA -->
      <section>
        <h2 class="text-2xl font-bold mb-3 border-l-4 border-blue-600 pl-3">Tentang Pelatihan AA</h2>
        <p class="text-lg leading-relaxed">
          Pelatihan Applied Approach (AA) adalah program pengembangan kompetensi dosen untuk meningkatkan keterampilan pedagogik melalui metode pembelajaran aktif, kolaboratif, dan berbasis praktik nyata. Pelatihan ini bertujuan meningkatkan efektivitas pembelajaran dan penerapan teknologi pendidikan di perguruan tinggi.
        </p>
      </section>

      <!-- Manfaat -->
      <section>
        <h2 class="text-2xl font-bold mb-3 border-l-4 border-blue-600 pl-3">Manfaat Pelatihan</h2>
        <ul class="list-disc pl-6 space-y-2 text-lg">
          <li>Meningkatkan kemampuan dosen dalam menerapkan pembelajaran berbasis praktik.</li>
          <li>Mendukung pengembangan perangkat pembelajaran yang inovatif dan aplikatif.</li>
          <li>Meningkatkan keterampilan asesmen dan evaluasi berbasis kompetensi.</li>
        </ul>
      </section>

      <!-- Jadwal & Pendaftaran -->
      <section>
        <h2 class="text-2xl font-bold mb-3 border-l-4 border-blue-600 pl-3">Jadwal & Pendaftaran</h2>
        <p class="text-lg mb-4">
          Informasi jadwal pelatihan Applied Approach tahun berjalan akan diumumkan secara berkala. 
          Dosen dapat melakukan pendaftaran melalui tautan resmi LPMPP.
        </p>
        <a href="#" class="px-5 py-3 bg-blue-700 text-white font-semibold rounded-lg shadow hover:bg-blue-800 transition">
          Daftar Pelatihan →
        </a>
      </section>
      ...
      <!-- Materi Inti -->
      <section>
        <h2 class="text-2xl font-bold mb-3 border-l-4 border-blue-600 pl-3">📘 Materi Pelatihan</h2>
        <div class="grid md:grid-cols-2 gap-6">
          <div class="p-5 bg-blue-50 rounded-xl shadow hover:shadow-lg transition">
            <h3 class="font-bold text-xl mb-2 text-blue-700">Rencana Pembelajaran Praktik</h3>
            <p>Penyusunan RPS yang menekankan penerapan teori melalui praktik langsung.</p>
          </div>
          <div class="p-5 bg-indigo-50 rounded-xl shadow hover:shadow-lg transition">
            <h3 class="font-bold text-xl mb-2 text-indigo-700">Metode Pembelajaran Aktif</h3>
            <p>Penerapan strategi pembelajaran kolaboratif, problem-based, dan project-based.</p>
          </div>
          <div class="p-5 bg-purple-50 rounded-xl shadow hover:shadow-lg transition">
            <h3 class="font-bold text-xl mb-2 text-purple-700">Evaluasi & Asesmen Praktik</h3>
            <p>Teknik penilaian kompetensi mahasiswa berbasis praktik dan proyek.</p>
          </div>
          <div class="p-5 bg-pink-50 rounded-xl shadow hover:shadow-lg transition">
            <h3 class="font-bold text-xl mb-2 text-pink-700">Integrasi Teknologi</h3>
            <p>Pemanfaatan LMS, e-learning, dan media digital dalam pelatihan dan perkuliahan.</p>
          </div>
        </div>
      </section>
